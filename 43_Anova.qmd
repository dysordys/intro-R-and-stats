...
To complete the modeling from @eq-penguin-quant, we’ll include Species and Sex in the model. We need to create two and one indicator variables respectively:
