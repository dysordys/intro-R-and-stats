...
3. Create a table where the rows are the three species, and the columns are: average petal length, variance of petal length, average sepal length, and variance of sepal length (each across flowers of the corresponding species).
...
7. What is the average shell size of the whole community? What is its standard deviation? How about the average and standard deviation of shell shape?
