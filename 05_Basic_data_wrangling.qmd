...
7.  Sort the data in reverse alphabetical order of species names, but within each species, sort them by increasing petal length. If all went well, your result should begin with the following rows:
    ```{r}
    #| echo: false
    as_tibble(iris) |>
