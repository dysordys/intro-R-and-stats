# Comparing two groups {#sec-wilcox}
...
As seen, the 95% confidence intervals exhibit substantial overlap. While that by itself is not conclusive, it is an indication that the difference between the two samples may not be as relevant as it might have initially looked.
